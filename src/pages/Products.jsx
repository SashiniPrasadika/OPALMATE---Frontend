...
const Products = () => {
  ...
  const [formData, setFormData] = useState({ name: "", category: "", price: "", stock: "", status: "Active" });
  ...
  return (
    <div className="products-container">
      <div className="products-header">
        ...
        <button className="add-btn" onClick={handleAddProduct}><FaPlus /> Add Product</button>
      </div>
